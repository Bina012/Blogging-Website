...
<head>
    <base href="../../../../">
    <meta charset="utf-8" />
    <title>Admin Login | Project Name</title>
    ...
    <link href="{{url('cd-assets/css/pages/login/classic/login-4.css')}}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed subheader-mobile-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('cd-assets/media/bg/bg-3.jpg');">
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    <!--begin::Login Header-->
                    <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="{{url('cd-assets/media/logos/logo-letter-13.png')}}" class="max-h-75px" alt="" />
                        </a>
                    </div>
                    <!--end::Login Header-->
                    ...
                    <div class="login-signin">
                        <div class="mb-20">
                            ...
                            <div class="text-muted font-weight-bold">Enter your Credentials to login to your account:</div>
                        </div>
                        <form class="form" action="{{route('loginSubmit')}}" method="POST">
                            @csrf
    ...
    <script src="{{url('cd-assets/js/pages/custom/login/login-general.js')}}"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
